...
```{r , echo=FALSE}
ap3_a <- ggplot(filter(data, ROI == "hemisphere")) +
  geom_point(aes(x = Age, y = AvgThickness, alpha = 0.4),  color = "grey") +
  geom_point(aes(x = Age, y = AvgThickness_age_decay, alpha = 0.4), color = "darkblue") +
  geom_smooth(method = "lm", aes(x = Age, y = AvgThickness), color = "grey") +
  geom_smooth(method = "lm", aes(x = Age, y = AvgThickness_age_decay), color = "darkblue") +
...
ap3_b <- ggplot(filter(data, ROI == "hemisphere")) +
  geom_point(aes(x = Age, y = K, alpha = 0.4),  color = "grey") +
  geom_point(aes(x = Age, y = K_age_decay, alpha = 0.4), color = "darkblue") +
  geom_smooth(method = "lm", aes(x = Age, y = K), color = "grey") +
  geom_smooth(method = "lm", aes(x = Age, y = K_age_decay), color = "darkblue") +
...
ap3 <- 
  ggarrange(ap3_a, ap3_b, labels = c("A","B"), nrow = 2, ncol = 1, font.label = list(size = 11), common.legend = TRUE, legend = "top")

ggsave("ap3.pdf", ap3, dpi=1200, width = 11.4, height = 11.4, units = "cm", device = "pdf")
```
...
```{r, echo=FALSE}
ap4_a <- ggplot(filter(data, ROI == "hemisphere"), aes(x = Age, y = K, color = Sample, fill = Sample), alpha = 0.4) +
...
```{r, echo=FALSE}
ap4_b <- ggplot(filter(data, ROI == "hemisphere"), aes(x = Age, y = K, color = Sample, fill = Sample), alpha = 0.4) +
...
```{r, echo=FALSE}
ap4_c <- ggplot(filter(data, ROI == "hemisphere"),
       aes(x = Age, y = K),
       alpha = 0.4) +
  geom_smooth(method = "lm",
              fullrange = TRUE,
...
ap4 <- 
  ggarrange(ap4_a, ap4_c, labels = c("A","B"), nrow = 2, ncol = 1, font.label = list(size = 11), common.legend = TRUE, legend = "top")

ggsave("ap4.pdf", ap4, dpi=1200, width = 17.8, height = 22, units = "cm", device = "pdf")
```
...
```{r , echo=FALSE}
ap9_a <- ggplot(filter(data, ROI == "hemisphere")) +
  geom_point(aes(x = Age, y = AvgThickness, alpha = 0.4),  color = "grey") +
...
t_b <- ggplot(filter(data, ROI == "hemisphere"), aes(x = Age, y = AvgThickness), alpha = 0.4) +
  ...
  theme_pubr() +
    scale_x_continuous(name ="Age", 
                    limits=c(0,100),
                breaks=c(seq(0,100,25))) # human lifespa
...
t_c <- ggplot(filter(data, ROI == "hemisphere"), aes(x = Age, y = AvgThickness_shiftc,  color = Sample, fill = Sample), alpha = 0.4) +
 ...
 ap6 <-  ggarrange(t_a, t_b, t_c, t_d, nrow =2 , ncol = 2 , font.label = list(size = 11), common.legend = TRUE, legend = "top")
 ap6
 
 ggsave("ap6.pdf", ap6, dpi=1200, width = 17.8, height = 17.8, units = "cm", device = "pdf")
...
```{r , echo=FALSE}
ap9_b <- ggplot(filter(data, ROI == "hemisphere")) +
  geom_point(aes(x = Age, y = K, alpha = 0.4),  color = "grey") +
...
ap9 <- 
  ggarrange(ap9_a, ap9_b, labels = c("A","B"), nrow = 2, ncol = 1, font.label = list(size = 11), common.legend = TRUE, legend = "top")
ggsave("ap9.pdf", ap9, dpi=1200, width = 11.4, height = 11.4, units = "cm", device = "pdf")
...
ap7 <-  ggarrange(k_a, k_b, k_c, k_d, labels = c("A","B","C","D"), nrow =2 , ncol = 2 , font.label = list(size = 11), common.legend = TRUE, legend = "top")
ap7
 
ggsave("ap7.pdf", ap7, dpi=1200, width = 17.8, height = 17.8, units = "cm", device = "pdf")
```
